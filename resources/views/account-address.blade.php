    ...
    <div class="grid lg:grid-cols-12 grid-cols-6 gap-8">
        ...
        <div class="col-span-8 lg:mt-0 mt-7">
                    ...
                    <div class="bg">
                        <div class="py-10 px-6">
                                ...
                                <div class="flex justify-between">
                                    <h6 class="font-medium text-2xl">Shipping Address</h6>
                ...
                <div class="col-span-6">
                    <div class="bg">
                        <div class="py-10 px-6">
                                <!-- Heading -->
                                <div class="flex justify-between">
                                    <h6 class="font-medium text-2xl">Billing Address</h6>
                                <div class="flex justify-end gap-1">
                                    <div class="w-12 h-12 bg-white rounded-full flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
            ...
            <div class="mt-14 border py-4">
                <a href="/account-address.html" class="flex justify-center items-center gap-2 text-lg font-medium Ca">
                    Add Address
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
